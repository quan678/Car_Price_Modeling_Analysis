...
## Overview
This project is dedicated to analyze the car market and predicts car values based on a variety of attributes such as model, year, and specifications. The project mainly focus on comprehensive data cleaning, exploratory data analysis (EDA) to derive insights and predictive accuracy.
